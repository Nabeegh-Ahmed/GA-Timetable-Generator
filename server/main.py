...
def api_input(off_day, consecutives, last_class, first_class):
    off_days = [off_day]
    FITNESS_CONDITIONS.append(off_days)
    FITNESS_CONDITIONS.append(consecutives)
    FITNESS_CONDITIONS.append(last_class)
    FITNESS_CONDITIONS.append(first_class)
